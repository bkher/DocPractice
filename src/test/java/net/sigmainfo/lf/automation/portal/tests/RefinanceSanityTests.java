...
import net.sigmainfo.lf.automation.portal.pages.Borrower.ProfileSection.RefinanceLoanAmountPage;
import net.sigmainfo.lf.automation.portal.pages.Borrower.ProfileSection.RefinancePropertyDetailsPage;
 ...
 */
public class RefinanceSanityTests extends AbstractTests {

	private Logger logger = LoggerFactory.getLogger(RefinanceSanityTests.class);
	public static String funcMod = "Refinance";
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "LenderBorrowerNonSpouseAddedCoborrowerFlow" })
	public void LenderBorrowerNonSpouseAddedCoborrowerFlow() throws Exception {
		...
		try {
			...
			RefinancePropertyDetailsPage refinancePropertyDetailsPage = new RefinancePropertyDetailsPage(driver);
			refinancePropertyDetailsPage.providePropertyDetails(driver);
			RefinanceLoanAmountPage refinanceLoanAmountPage = new RefinanceLoanAmountPage(driver);
			refinanceLoanAmountPage.enterLoanDetails(driver);
			...
			PurchaseAndSalePage purchaseAndSalePage1 = new PurchaseAndSalePage(driver);
			purchaseAndSalePage1.CompleteVerification();
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "DirectSignupBorrowerCoborrowerFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "LenderBorrowerIndividualCreditFlow" })
	public void LenderBorrowerIndividualCreditFlow() throws Exception {
		...
		try {
			...
			PurchaseAndSalePage purchaseAndSalePage1 = new PurchaseAndSalePage(driver);
			purchaseAndSalePage1.CompleteVerification_skip();
			ChildSupportPage childSupportPage = new ChildSupportPage(driver);
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "DirectSignupBorrowerIndividualFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "DirectSignUpBorrowerCoborrwerNonSpouseFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "DirectSignUpBorrowerCoborrwerUnmarriedFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "LenderBorrowerCoborrwerNonSpouseFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity",
			"LenderBorrowerMarriedSeparatedAddedCoborrowerFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "LenderBorrowerCoborrwerMarriedSeparatedFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "LenderBorrowerSpouseAddedCoborrowerFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "BorrowerInviteSpouseLoginAndCompleteApplication" })
	public void BorrowerInviteSpouseLoginAndCompleteApplication() throws Exception {
		...
		try {
			...
			RefinancePropertyDetailsPage refinancePropertyDetailsPage1 = new RefinancePropertyDetailsPage(driver);
			refinancePropertyDetailsPage1.providePropertyDetails_SpouseVerifyHisSpouseDetails(driver);
			RefinanceLoanAmountPage refinanceLoanAmountPage1 = new RefinanceLoanAmountPage(driver);
			refinanceLoanAmountPage1.enterLoanDetails_SpouseVerifyHisSpouseDetails(driver);
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "LenderBorrowerCoborrwerAddedSpouseFlow" })
	...
	@Test(description = "", groups = { "RefinanceTests", "Sanity", "CoborrwerAddedSpouseLoginCompleteApplication" })
