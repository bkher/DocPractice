...
/**
 * Created by Shaishav.s on 23-04-2018.
 */
@Component
public class StringEncrypter {

    public static StringEncrypter encrypter = null;
     ...
     * @throws EncryptionException
     */
    public StringEncrypter(final String anEncryptionScheme, final String anEncryptionKey) throws EncryptionException {
    ...
    public static void main(String[] args) throws EncryptionException {
        StringEncrypter scEncrypter = StringEncrypter.createNewEncrypter();

        //System.out.println(scEncrypter.decrypt("nUZZ4MEf2KYaZs/n4coLNw==")); //Jan@2017
        System.out.println(scEncrypter.encrypt("Test@123"));
        System.out.println(scEncrypter.decrypt("zDnE0JHsAH0aZs/n4coLNw==")); //Sigma@123
    }
}
